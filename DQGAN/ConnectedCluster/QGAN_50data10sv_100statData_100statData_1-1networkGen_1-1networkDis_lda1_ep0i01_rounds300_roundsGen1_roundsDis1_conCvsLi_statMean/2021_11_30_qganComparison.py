...
def QGANStatisticsVsLine(blochPossible,fileName, trainingRoundNr,trainingData, numTestingData, numTest, numTrainingData, numIn, qnnArchGen, networkUnitariesGen, testingData, indexDataTest, indexDataTrain, qnnArchGenString, qnnArchDisString):
    ...
    n=len(dataC)
    data=connectedClusters(n,qnnArchGen[-1])
    incomes = randomStates(numIn, numTest)
    outcomes = feedforwardGAN(qnnArchGen, networkUnitariesGen, incomes)
    outputStates = []
    for i in range(len(outcomes)):
...
line1 = line(numData,1)
#QGANMeans([1, 1, 1], 2, line1, 1, 0.01, rounds, 1, 1, numTestingData, numTest, statRounds, "line",meanNum)

cluster1 = connectedClusters(numData,1)
QGANMeansVsLine([1, 1, 1], 2, cluster1, 1, 0.01, rounds, 1, 1, numTestingData, numTest, statRounds, "conCvsLi",meanNum)

line2 = line(numData,2)
QGANMeans([1, 2, 1], 2, line2, 1, 0.01, rounds, 1, 1, numTestingData, numTest, statRounds, "line",meanNum)

cluster2 = connectedClusters(numData,2)
QGANMeansVsLine([1, 2, 1], 2, cluster2, 1, 0.01, rounds, 1, 1, numTestingData, numTest, statRounds, "conCvsLi",meanNum)

line3 = line(numData,3)
QGANMeans([1, 3, 1], 2, line3, 1, 0.01, rounds, 1, 1, numTestingData, numTest, statRounds, "line",meanNum)

cluster3 = connectedClusters(numData,3)
QGANMeansVsLine([1, 3, 1], 2, cluster3, 1, 0.01, rounds, 1, 1, numTestingData, numTest, statRounds, "conCvsLi",meanNum)

QGANMeans([2, 3, 2], 2, line3, 1, 0.01, rounds, 1, 1, numTestingData, numTest, statRounds, "line",meanNum)
QGANMeansVsLine([2, 3, 2], 2, cluster3, 1, 0.01, rounds, 1, 1, numTestingData, numTest, statRounds, "conCvsLi",meanNum)
